...
class StorageAsset(Asset):
    ...
    def _update_control_t(self, Pnet_t, t, enforce_const):
        ...
        P_ratio = max(1, min(P_ratio, 100)) #clamp to [1, 100]
...
class CurtailableAsset(Asset):
    ...
    def polytope(self, t0):
        ...
        if self.curt:
            ...
            b= np.concatenate(([self.Pnet_ems[t0]], self.Pnet_ems_pred[t0+1:], (1-self.curt)*[-self.Pnet_ems[t0]], -(1-self.curt)*self.Pnet_ems_pred[t0+1:]), axis=0) 
